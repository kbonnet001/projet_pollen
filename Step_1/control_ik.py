...
print("\n".join(sys.path))
from ik_pinocchio import symbolic_inverse_kinematics_continuous_pin, reduce_model_pin_arm 
...
class ControlIK:
    def __init__(  # noqa: C901
        ...
        for prefix in arms:
            ...
            # ajout-----------
            self.model[prefix], self.data[prefix] = reduce_model_pin_arm(prefix)
            # --------
    ...
    def symbolic_inverse_kinematics_continuous_with_pin(
        ...
        Args:
            ...
            d_theta_max: maximum angle difference between two consecutive theta
        """
        print("yaaaaaaaaaaaaaaaaaaaaaaaaaa")
        ...
        if is_reachable:
            ...
            ik_joints, _, _ = symbolic_inverse_kinematics_continuous_pin(self.model[name[0]], self.data[name[0]], current_joints, goal_pose)
